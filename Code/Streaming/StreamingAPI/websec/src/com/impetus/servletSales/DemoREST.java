...
/**
 * @author nidhi.neema Servlet for REST calls for Account creation and updation
 *         at sfdc.
 */
...
public class DemoREST extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		// String accountId = "0019000000PdgH2AAJ";//createAccount("My New Org",
		...
		// updateAccount(accountId, "My New Org, Inc -1", "San Francisco",
		// instanceUrl, accessToken, writer);
